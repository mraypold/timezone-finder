...
describe('Timezone route', () => {
  describe('index (/)', () => {
    ...
    it('Returns 400 when missing a longitude param', (done) => {
    ...
    it('Returns 400 when missing a latitude param', (done) => {
    ...
    it('Returns 400 when given a malformed longitude param', (done) => {
    ...
    it('Returns 400 when given a malformed latitude param', (done) => {
    ...
    it('Returns a timezone when given points in a valid timezone', (done) => {
